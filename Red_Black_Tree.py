...
class RedBlackTree():
    ...
    def print_structure(self, node, indent, last):
        ...
        if node != self.TNULL:
            ...
            self.print_structure(node.left, indent, False)
            self.print_structure(node.right, indent, True)
    ...
    #     self.print_structure(self.root, "", True)
